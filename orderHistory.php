            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-6">
                    <div class="col-md-11 col-sm-11">
                        <div class="row">
                            <h4 class="titleStyle"> Order History</h4>
                            ...
                            <form action="" method="post">
                                <table width="50%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                                    ...
                                    <tr>
                                        <td>To Date</td>
                                        <td><input type="text" name="todate" id="todate" placeholder="YYYY-MM-DD"></td>
                                    </tr>
                                    <tr>
                                        <td>&nbsp;</td>
...
//echo $sql;
                                ...
                                <table width="100%" border="1" cellspacing="0" cellpadding="0" class="table table-bordered">
                                    ...
                                    $sql = "SELECT order_tbl.*,user.username FROM order_tbl INNER JOIN user 
ON order_tbl.createduser = user.id 
WHERE  order_tbl.updateuser = '" . $waiterID . "' AND DATE(order_tbl.updatedate) = DATE(now()) ";
