...
MySQL - 5.5.38 : Database - sresto_db
*********************************************************************
*/
...
insert  into `order_tbl`(`id`,`totalamount`,`status`,`createddate`,`createduser`,`updatedate`,`updateuser`) values (1,'8500','CLS','2017-04-07 13:57:03',4,'2017-04-07 16:45:19','5');
...
insert  into `orderitem`(`id`,`orderid`,`itemid`,`qty`) values (1,1,1,3),(2,1,2,2);
