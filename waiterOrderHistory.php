            ...
            <div class="row">
                ...
                <div class="col-md-8 col-sm-6">
                    <div class="col-md-11 col-sm-11">
                        <div class="row">
                            <h4 > Waiter Order History </h4>

                            <form action="" method="post">
                                <table width="50%" border="0" cellspacing="0" cellpadding="0" class="table table-bordered">
                                    <tr>
                                        <td>Waiter</td>
                                        <td> <select name="waiterid" id="waiterid">
										<?php
										 ...
										 $conn = getDBConnection();
                                            ...
                                            $sql = "SELECT * FROM user WHERE role = 'WTR' ";
...
WHERE  order_tbl.updateuser = '" . $waiterID . "' AND DATE(order_tbl.updatedate) >= '" . $_POST['fromdate'] . "' 
AND DATE(order_tbl.createddate) <= '" . $_POST['todate'] . "'   ";
...
//echo $sql;
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="orderPreview.php?orderID=<?php echo $row["id"]; ?>&status=CLS&btn=Close and Bill"><?php echo $row["status"]; ?></a></td>
                                ...
                                <table width="100%" border="1" cellspacing="0" cellpadding="0">
                                    ...
                                    $sql = "SELECT order_tbl.*,user.username FROM order_tbl INNER JOIN user 
ON order_tbl.createduser = user.id 
WHERE order_tbl.status = 'ACT'  AND DATE(order_tbl.createddate) = now() ";
                                    $result = mysqli_query($conn, $sql);
